...
# model_name=PatchTST_attn_weight_global
# model_name=PatchTST_attn_weight_global_indiv
model_name=PatchTST_attn_weight_corr_dmodel_indiv
...
# for seq_len in 336 504 1200 2400
# for seq_len in 336
