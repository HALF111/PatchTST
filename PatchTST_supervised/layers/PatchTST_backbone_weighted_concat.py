...
# Cell
class PatchTST_backbone_weighted_concat(nn.Module):
    def __init__(self, 
                 c_in:int, 
                 context_window:int, 
                 target_window:int, 
...
class WeightMask(nn.Module):
    def __init__(self, data_len, segment_len=None, acf_lst=None, weight_lst=None) -> None:
        super().__init__()
    ...
    def forward(self, x):
        ...
        # self.weight_lst = self.weight_lst.to(x.device)
        # self.weight_lst += mask_for_print
